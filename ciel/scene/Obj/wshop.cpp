...
int wshop::SetAitem(int a, int kk, int fd, int frs, int rb, int p, int k, int r, int h, int ri, int d, int t, int f, int sr, int sb)
{
    gRice = ri;
    gDango = d;
    gTea = t;
...
int wshop::SsFish(void)
{
    return kFish;
}

int wshop::SsStoneR(void)
{
    return kStoneR;
}

int wshop::SsStoneB(void)
{
    return kStoneB;
}
